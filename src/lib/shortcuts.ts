...
const environmentManagement = new Map<string, Shortcut>([
  ...
  ["Open Next Editor", { combos: ["shift+cmd+]", "alt+cmd+right", "ctrl+pagedown"], commands: ["workbench.action.nextEditor"], list: "Environment Management", src: "" }],
  ["Open Previous Editor", { combos: ["shift+cmd+[", "alt+cmd+left", "ctrl+pagedown"], commands: ["workbench.action.previousEditor"], list: "Environment Management", src: "" }],
  ...
  ["Show All Commands", { combos: ["shift+cmd+p", "ctrl+shift+p", "f1"], commands: ["workbench.action.showCommands"], list: "Environment Management", src: "" }],
